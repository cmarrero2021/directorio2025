<template>
  ...
  <div class="q-ml-md q-mr-md q-mb-xl sections-wrapper">
    <div class="row items-stretch no-wrap">
      <div class="col-12 q-mb-xl q-px-sm ">
        <div class="text-left">
          ...
          <p class="q-ml-xl">
            El Observatorio Nacional de Ciencia Tecnología e Innovación como ente responsable de la medición de la productividad de investigación y desarrollo del país, presenta a los editores de las revistas científicas venezolanas el Directorio Venezolano de Revistas Científicas y Tecnológicas como la guía oficial de información sobre las revistas científicas arbitradas y no arbitradas existentes en el territorio venezolano.  Presenta un criterio de inclusión de las producciones de los sectores del Sistema Nacional de ciencia, Tecnología e Innovación (SNCTI), tales como: Educación Universitaria, Industria, Administración Pública Nacional y Poder Popular.
Este espacio es para dar orientaciones a los editores para futuras incorporaciones de revistas y adecuaciones en los datos de las ya existentes en la plataforma.</p>
          <p class="q-ml-xl">
Para cualquier solicitud de incorporación o cambio de datos, escribir a: <a href="mailto:directoriovenezolano@gmail.com" style="color:blue;">directoriovenezolano@gmail.com</a>  o  <a href="mailto:divulgación@oncti.gob.ve" style="color:blue;">divulgación@oncti.gob.ve</a>
